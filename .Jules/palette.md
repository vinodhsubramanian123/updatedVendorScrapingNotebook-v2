...
## 2026-08-28 - [Accessible Keyboard Navigation on Custom Tabs]
**Learning:** Found that custom tab buttons lacked focus styles (`focus-visible:ring`), making them inaccessible for keyboard navigation.
**Action:** Always include `focus-visible:ring` and appropriate ring colors when designing custom interactive elements like tabs to support keyboard accessibility without relying solely on default browser outlines.
