...
`;
  ...
  await t.test('CTO multi-node splitting and fractional anomaly detection', (t2) => {
    const items = [
      ...
      { sku: 'P49611-B21', description: 'Intel Xeon-G 6430 2.1GHz 32-core 270W Processor', quantity: '10' },
      { sku: 'P43322-B21', description: 'HPE 32GB 1Rx4 PC5-4800B-R Smart Kit', quantity: '40' },
      { sku: 'P40502-B21', description: 'HPE 800W Flex Slot Platinum Hot Plug Low Halogen Power Supply Kit', quantity: '10' },
      { sku: 'U44H5E', description: 'HPE 3 Year Tech Care Essential Service', quantity: '5' }
    ];
    ...
    const invalidItems = [
      { sku: 'P73282-B21', description: 'HPE ProLiant DL380 Gen12 8SFF CTO Server', quantity: '5' },
      { sku: 'P49611-B21', description: 'Intel Xeon-G 6430 2.1GHz 32-core 270W Processor', quantity: '7' }
    ];
  ...
  await t.test('BTO-to-FIO substitution detection and constraint anomalies', (t2) => {
    const items = [
      ...
      { sku: 'P43322-B21', description: 'HPE 32GB 1Rx4 PC5-4800B-R Smart Memory Kit', quantity: '1', atomicQuantity: 1 }
    ];
