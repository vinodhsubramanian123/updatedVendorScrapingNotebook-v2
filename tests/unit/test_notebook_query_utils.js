...
const { sanitizeNotebookQuery, postProcessNotebookResult, executeNotebookQuery } = require('../../scripts/lib/notebook/notebook_query_utils.js');
...
async function testSuite() {
  ...
  console.log('\n🤖 Skipping live query execution test against Gemini Notebook to avoid network dependencies in CI...');
  // The actual executeNotebookQuery logic is skipped for unit tests unless a mock is implemented.

  // --- TEST 6: Async Non-Blocking Query Job Launch & Status Polling ---
  console.log('\n⚡ Testing Async Non-Blocking Query Job Engine...');
  const { startAsyncNotebookQueryJob, getAsyncNotebookQueryJobStatus, diagnoseNotebookFailure } = require('../../scripts/lib/notebook/notebook_query_utils.js');
