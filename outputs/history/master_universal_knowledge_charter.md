...
**Document Version**: `2.0.0` | **Generated**: `2026-09-18T17:36:02.480Z`  
...
**Total Verified Knowledge Deltas**: `73` (`0` Universal + `0` Family/Gen + `73` Chassis Specific)  
...
### 21. [DELTA_DL380A_GEN12_LIVE_OCA_PRICING_ALIGNMENT_5155756524-01] DL380a_Gen12 — LIVE_QUOTE_RECONCILIATION
- **Scope**: `CHASSIS_SPECIFIC`
...
### 22. [DELTA-1789752537004-v9j6p] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
...
### 23. [DELTA-1789752537592-otj9t] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on S4A91C (drive)
- **Affected SKU**: `S4A91C`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 24. [DELTA-1789752537783-790yf] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on HA113A1 (support)
- **Affected SKU**: `HA113A1`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 25. [DELTA-1789752537975-31r35] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on HU4B2A30C4W (service)
- **Affected SKU**: `HU4B2A30C4W`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 26. [DELTA_DL380_GEN12_NO_DRIVE_BYPASS] DL380_Gen12 — STORAGE_OVERRIDE
- **Scope**: `FAMILY_GEN`
...
### 27. [DELTA_DL380_GEN12_LOCALIZATION_GATE] DL380_Gen12 — LOCALIZATION_GATE
- **Scope**: `FAMILY_GEN`
...
### 28. [DELTA_DL380_GEN12_COM_SAAS_MANDATE] DL380_Gen12 — MANAGEMENT_LICENSING
- **Scope**: `FAMILY_GEN`
...
### 29. [DELTA_DL380_GEN12_LOT9_CE_BYPASS] DL380_Gen12 — POWER_BYPASS
- **Scope**: `FAMILY_GEN`
- **Rule**: If Platinum PSUs are selected on Gen12, P35876-B21 clears EU Lot 9 CE prompts.
- **Affected SKU**: `P38995-B21`
- **Required Dependency**: `P35876-B21`

### 30. [DELTA_DL380_GEN12_25C_AMBIENT_TRACKING] DL380_Gen12 — THERMAL_TRACKING
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: P79558-B21 tracks 25C ambient baseline for Gen12 chassis.
- **Affected SKU**: `P73282-B21`
- **Required Dependency**: `P79558-B21`

### 31. [DELTA_DL380_GEN12_HIGH_TDP_COOLING] DL380_Gen12 — COOLING_MANDATE
- **Scope**: `FAMILY_GEN`
...
### 32. [DELTA_DL380_MISSING_SUPPORT_CONTRACT] DL380_Gen12 — DEPENDENCY
...
### 44. [DELTA-1786880394092] DL380_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
...
### 45. [DELTA-1787315096377] DL380_Gen12 — RULE
- **Scope**: `FAMILY_GEN`
- **Rule**: If P69728-F21 is present, DDR5-6400 is mandatory.
- **Affected SKU**: `P69728-F21`
- **Required Dependency**: `DDR5-6400`

### 46. [DELTA_RAG_FIO_P69728-B21_P69728-F21_1788145618089] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
...
### 47. [DELTA_RAG_DEP_P75740-B21_873763-B21_1788145618089] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 48. [DELTA_RAG_DEP_P28586-B21_P75740-B21_1788145618089] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 49. [DELTA_RAG_DEP_P51083-B21_P74573-B21_1788145618091] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 50. [DELTA_RAG_DEP_P47777-B21_P01366-B21_1788145618091] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 51. [DELTA_RAG_DEP_P28586-B21_P40430-B21_1788145618092] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 52. [DELTA_RAG_DEP_P76453-B21_P75740-B21_1788145618092] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 53. [DELTA_RAG_FIO_P64707-B21_P69728-F21_1788148383105] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
...
### 54. [DELTA_RAG_DEP_P48818-B21_P38995-B21_1788148383108] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 55. [DELTA_RAG_DEP_P75740-B21_P75741-B21_1788148383112] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 56. [DELTA_RAG_CARRYOVER_P47777-B21_1788459469422] DL380_Gen12 — CARRY_OVER_VALIDATED
- **Scope**: `CHASSIS_SPECIFIC`
...
### 57. [DELTA_RAG_DEP_P01366-B21_P48918-B21_1788459469423] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 58. [DELTA_RAG_DEP_P10180-B21_P72203-B21_1788459469424] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 59. [DELTA_RAG_DEP_P74573-B21_P48820-B21_1788461136463] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 60. [DELTA_RAG_DEP_P74573-B21_P74792-B21_1788461136464] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 61. [DELTA-1788462981839] DL380_Gen12 — RULE
- **Scope**: `FAMILY_GEN`
...
### 62. [DELTA_RAG_DEP_P76453-B21_P48918-B21_1788463665182] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
