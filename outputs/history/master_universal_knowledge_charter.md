...
**Document Version**: `2.0.0` | **Generated**: `2026-09-18T17:18:38.601Z`  
...
**Total Verified Knowledge Deltas**: `69` (`0` Universal + `0` Family/Gen + `69` Chassis Specific)  
...
### 22. [DELTA_DL380_GEN12_NO_DRIVE_BYPASS] DL380_Gen12 — STORAGE_OVERRIDE
- **Scope**: `FAMILY_GEN`
...
### 23. [DELTA_DL380_GEN12_LOCALIZATION_GATE] DL380_Gen12 — LOCALIZATION_GATE
- **Scope**: `FAMILY_GEN`
...
### 24. [DELTA_DL380_GEN12_COM_SAAS_MANDATE] DL380_Gen12 — MANAGEMENT_LICENSING
- **Scope**: `FAMILY_GEN`
...
### 25. [DELTA_DL380_GEN12_LOT9_CE_BYPASS] DL380_Gen12 — POWER_BYPASS
- **Scope**: `FAMILY_GEN`
- **Rule**: If Platinum PSUs are selected on Gen12, P35876-B21 clears EU Lot 9 CE prompts.
- **Affected SKU**: `P38995-B21`
- **Required Dependency**: `P35876-B21`

### 26. [DELTA_DL380_GEN12_25C_AMBIENT_TRACKING] DL380_Gen12 — THERMAL_TRACKING
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: P79558-B21 tracks 25C ambient baseline for Gen12 chassis.
- **Affected SKU**: `P73282-B21`
- **Required Dependency**: `P79558-B21`

### 27. [DELTA_DL380_GEN12_HIGH_TDP_COOLING] DL380_Gen12 — COOLING_MANDATE
- **Scope**: `FAMILY_GEN`
...
### 28. [DELTA_DL380_MISSING_SUPPORT_CONTRACT] DL380_Gen12 — DEPENDENCY
...
### 40. [DELTA-1786880394092] DL380_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
...
### 41. [DELTA-1787315096377] DL380_Gen12 — RULE
- **Scope**: `FAMILY_GEN`
- **Rule**: If P69728-F21 is present, DDR5-6400 is mandatory.
- **Affected SKU**: `P69728-F21`
- **Required Dependency**: `DDR5-6400`

### 42. [DELTA_RAG_FIO_P69728-B21_P69728-F21_1788145618089] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
...
### 43. [DELTA_RAG_DEP_P75740-B21_873763-B21_1788145618089] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 44. [DELTA_RAG_DEP_P28586-B21_P75740-B21_1788145618089] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 45. [DELTA_RAG_DEP_P51083-B21_P74573-B21_1788145618091] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 46. [DELTA_RAG_DEP_P47777-B21_P01366-B21_1788145618091] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 47. [DELTA_RAG_DEP_P28586-B21_P40430-B21_1788145618092] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 48. [DELTA_RAG_DEP_P76453-B21_P75740-B21_1788145618092] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 49. [DELTA_RAG_FIO_P64707-B21_P69728-F21_1788148383105] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
...
### 50. [DELTA_RAG_DEP_P48818-B21_P38995-B21_1788148383108] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 51. [DELTA_RAG_DEP_P75740-B21_P75741-B21_1788148383112] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 52. [DELTA_RAG_CARRYOVER_P47777-B21_1788459469422] DL380_Gen12 — CARRY_OVER_VALIDATED
- **Scope**: `CHASSIS_SPECIFIC`
...
### 53. [DELTA_RAG_DEP_P01366-B21_P48918-B21_1788459469423] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 54. [DELTA_RAG_DEP_P10180-B21_P72203-B21_1788459469424] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 55. [DELTA_RAG_DEP_P74573-B21_P48820-B21_1788461136463] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 56. [DELTA_RAG_DEP_P74573-B21_P74792-B21_1788461136464] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 57. [DELTA-1788462981839] DL380_Gen12 — RULE
- **Scope**: `FAMILY_GEN`
...
### 58. [DELTA_RAG_DEP_P76453-B21_P48918-B21_1788463665182] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 59. [DELTA_SYNERGY_FRAME_STARTUP_MATH] SY480_Gen12 — STARTUP_SERVICE_FORMULA
- **Scope**: `FAMILY_GEN`
...
### 60. [DELTA_SYNERGY_VC_100GB_SUPPORT_ENTITLEMENT] SY480_Gen12 — HARDWARE_SUPPORT_1TO1
- **Scope**: `FAMILY_GEN`
...
### 61. [DELTA_SYNERGY_COMPOSER2_SUPPORT_ENTITLEMENT] SY480_Gen12 — HARDWARE_SUPPORT_1TO1
- **Scope**: `FAMILY_GEN`
...
### 62. [DELTA_SYNERGY_BROCADE_FC_SUPPORT_ENTITLEMENT] SY480_Gen12 — HARDWARE_SUPPORT_1TO1
- **Scope**: `FAMILY_GEN`
...
### 63. [DELTA_SYNERGY_COMPUTE_MODULE_SUPPORT_ENTITLEMENT] SY480_Gen12 — HARDWARE_SUPPORT_1TO1
- **Scope**: `FAMILY_GEN`
...
### 64. [DELTA_SYNERGY_WARRANTY_VS_STARTUP_DECOUPLING] SY480_Gen12 — DECOUPLING
...
### 65. [DELTA_SYNERGY_REMOTE_ONSITE_CONFLICT] SY480_Gen12 — EXCLUSION
- **Scope**: `Synergy/Gen12/SY480_Gen12`
...
### 66. [DELTA_OCA_RULE_81039677_CROSS_ICON_ATTRIBUTION] GLOBAL — DIAGNOSTIC
- **Scope**: `Universal`
...
### 67. [DELTA_SYNERGY_ICON_ISOLATION_GUARDRAIL] SY480_Gen12 — ISOLATION
- **Scope**: `Synergy/Gen12/SY480_Gen12`
...
### 68. [DELTA_OCA_SUPPORT_CACHE_FLUSH_PROTOCOL] GLOBAL — PROCEDURE
- **Scope**: `Universal`
...
### 69. [DELTA_SYNERGY_STARTUP_PLACEMENT_HIERARCHY] SY480_Gen12 — PLACEMENT
- **Scope**: `Synergy/Gen12/SY480_Gen12`
