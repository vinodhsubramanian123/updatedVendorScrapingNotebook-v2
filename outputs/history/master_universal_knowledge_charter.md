...
**Document Version**: `2.0.0` | **Generated**: `2026-09-24T17:40:07.482Z`
...
### 1. [DELTA_UNIVERSAL_MULTI_ICON_ERROR_ATTRIBUTION] GLOBAL — ERROR_DIAGNOSTIC_ATTRIBUTION
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: When Rule 81039677 occurs on multi-icon tenders, trace errors to individual child icon containers instead of modifying the root BOM item.
- **Affected SKU**: `SOLUTION_TREE_ITEM_0100_01`

### 2. [DELTA_UNIVERSAL_SUPPORT_TIER_ISOLATION] GLOBAL — ICON_SUPPORT_ISOLATION
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: Configure support services independently per icon container. Never broadcast support attributes across diverse product families.
- **Affected SKU**: `HU4B2A3`

### 3. [DELTA_UNIVERSAL_OCA_SUPPORT_CACHE_FLUSH] GLOBAL — SESSION_RECOVERY_PROTOCOL
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: Historical service-selector workaround only: in an authenticated working OCA configuration with contradictory service selections, reselect services for the owning node and revalidate. It is not an expired-session recovery. If OCA displays encountered-a-problem, refresh/login from Partner Portal and launch One Config Advanced through Quick Links; never reload the failed OCA tab or remove services as a session fix.
- **Affected SKU**: `HU4B2A3`

### 4. [DELTA_DL145_GEN11_AMD_EPYC_8004] DL145_Gen11 — PROCESSOR_FAMILY
...
### 5. [DELTA_DL145_GEN11_4EDSFF_CAGE] DL145_Gen11 — DRIVE_CAGE_FORMAT
- **Scope**: `CHASSIS_SPECIFIC`
...
### 6. [DELTA_DL145_GEN11_PSU_PROFILE] DL145_Gen11 — PSU_WATTAGE_LIMIT
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: DL145 Gen11 supports maximum 1000W PSUs. 1600W/2400W PSUs are physically incompatible.
- **Affected SKU**: `P71964-B21`
- **Required Dependency**: `P54290-B21`

### 7. [DELTA_DL145_GEN11_EXTENDED_TEMP] DL145_Gen11 — EXTENDED_AMBIENT_TRACKING
- **Scope**: `CHASSIS_SPECIFIC`
...
### 14. [DELTA_CLIC_81354652_DL380_GEN11] DL380_Gen11 — PHYSICAL_POWER_ENABLEMENT
- **Scope**: `FAMILY_GEN`
...
### 15. [DELTA_CLIC_81355854_DL380_GEN11] DL380_Gen11 — MUTUAL_EXCLUSIVITY
- **Scope**: `FAMILY_GEN`
...
### 16. [DELTA_CLIC_81016755_DL380_GEN11] DL380_Gen11 — RISER_SLOT_ENABLEMENT
- **Scope**: `FAMILY_GEN`
...
### 17. [DELTA_CLIC_EU_LOT9_P35876_DL380_GEN11] DL380_Gen11 — REGULATORY_ENABLEMENT
- **Scope**: `FAMILY_GEN`
...
### 18. [DELTA_RAG_DEP_P02377-B21_P48918-B21_1787913302880] DL380_Gen11 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
- **Rule**: P02377-B21` or `P01366-B21` **mandates the inclusion of `P48918-B21
- **Affected SKU**: `P02377-B21`
- **Required Dependency**: `P48918-B21`

### 19. [DELTA_RAG_DEP_P58335-B21_P48918-B21_1787913632019] DL380_Gen11 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: P58335-B21`)** with the **Smart Storage Hybrid Capacitor (`P02377-B21`)** strictly requires `P48918-B21
- **Affected SKU**: `P58335-B21`
- **Required Dependency**: `P48918-B21`

### 20. [DELTA_RAG_DEP_write-cach_P48918-B21_1787915281069] DL380_Gen11 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: write-cache backup for `P58335-B21`; requires enablement cable **`P48918-B21
- **Affected SKU**: `write-cach`
- **Required Dependency**: `P48918-B21`

### 21. [DELTA_DL380A_GEN12_DRIVE_CAGE_EXCLUSIVITY] DL380a_Gen12 — STORAGE_COLLISION
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: DL380a prohibits mixing 4SFF cage P74710-B21 and 4EDSFF cage P74712-B21.
- **Affected SKU**: `P74710-B21`

### 22. [DELTA_DL380A_GEN12_DUAL_CPU_HOMOGENEOUS] DL380a_Gen12 — PROCESSOR_POPULATION
- **Scope**: `CHASSIS_SPECIFIC`
...
- **Affected SKU**: `HU4B2A30C4W`

### 25. [DELTA-1789752537004-v9j6p] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on P74700-B21 (memory)
- **Affected SKU**: `P74700-B21`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 26. [DELTA-1789752537592-otj9t] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on S4A91C (drive)
- **Affected SKU**: `S4A91C`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 27. [DELTA-1789752537783-790yf] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on HA113A1 (support)
- **Affected SKU**: `HA113A1`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 28. [DELTA-1789752537975-31r35] DL380a_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Observed price drift on HU4B2A30C4W (service)
- **Affected SKU**: `HU4B2A30C4W`
- **Engineering Rationale**: *Manual price drift reconciliation from phase 15 audit*

### 29. [DELTA_DL380_GEN12_NO_DRIVE_BYPASS] DL380_Gen12 — STORAGE_OVERRIDE
- **Scope**: `FAMILY_GEN`
...
### 30. [DELTA_DL380_GEN12_LOCALIZATION_GATE] DL380_Gen12 — LOCALIZATION_GATE
- **Scope**: `FAMILY_GEN`
...
### 31. [DELTA_DL380_GEN12_COM_SAAS_MANDATE] DL380_Gen12 — MANAGEMENT_LICENSING
- **Scope**: `FAMILY_GEN`
...
### 32. [DELTA_DL380_GEN12_LOT9_CE_BYPASS] DL380_Gen12 — POWER_BYPASS
- **Scope**: `FAMILY_GEN`
- **Rule**: If Platinum PSUs are selected on Gen12, P35876-B21 clears EU Lot 9 CE prompts.
- **Affected SKU**: `P38995-B21`
- **Required Dependency**: `P35876-B21`

### 33. [DELTA_DL380_GEN12_25C_AMBIENT_TRACKING] DL380_Gen12 — THERMAL_TRACKING
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: P79558-B21 tracks 25C ambient baseline for Gen12 chassis.
- **Affected SKU**: `P73282-B21`
- **Required Dependency**: `P79558-B21`

### 34. [DELTA_DL380_GEN12_HIGH_TDP_COOLING] DL380_Gen12 — COOLING_MANDATE
- **Scope**: `FAMILY_GEN`
...
### 35. [DELTA_DL380_MISSING_SUPPORT_CONTRACT] DL380_Gen12 — DEPENDENCY
...
### 47. [DELTA-1786880394092] DL380_Gen12 — RULE
- **Scope**: `CHASSIS_SPECIFIC`
...
### 48. [DELTA-1787315096377] DL380_Gen12 — RULE
- **Scope**: `FAMILY_GEN`
- **Rule**: If P69728-F21 is present, DDR5-6400 is mandatory.
- **Affected SKU**: `P69728-F21`
- **Required Dependency**: `DDR5-6400`

### 49. [DELTA_RAG_FIO_P69728-B21_P69728-F21_1788145618089] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
...
### 50. [DELTA_RAG_DEP_P75740-B21_873763-B21_1788145618089] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 51. [DELTA_RAG_DEP_P28586-B21_P75740-B21_1788145618089] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 52. [DELTA_RAG_DEP_P51083-B21_P74573-B21_1788145618091] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 53. [DELTA_RAG_DEP_P47777-B21_P01366-B21_1788145618091] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 54. [DELTA_RAG_DEP_P28586-B21_P40430-B21_1788145618092] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 55. [DELTA_RAG_DEP_P76453-B21_P75740-B21_1788145618092] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 56. [DELTA_RAG_FIO_P64707-B21_P69728-F21_1788148383105] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
...
### 57. [DELTA_RAG_DEP_P48818-B21_P38995-B21_1788148383108] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 58. [DELTA_RAG_DEP_P75740-B21_P75741-B21_1788148383112] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 59. [DELTA_RAG_CARRYOVER_P47777-B21_1788459469422] DL380_Gen12 — CARRY_OVER_VALIDATED
- **Scope**: `CHASSIS_SPECIFIC`
...
### 60. [DELTA_RAG_DEP_P01366-B21_P48918-B21_1788459469423] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 61. [DELTA_RAG_DEP_P10180-B21_P72203-B21_1788459469424] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 62. [DELTA_RAG_DEP_P74573-B21_P48820-B21_1788461136463] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
...
### 63. [DELTA_RAG_DEP_P74573-B21_P74792-B21_1788461136464] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 64. [DELTA-1788462981839] DL380_Gen12 — RULE
- **Scope**: `FAMILY_GEN`
...
### 65. [DELTA_RAG_DEP_P76453-B21_P48918-B21_1788463665182] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
...
### 66. [DELTA_RAG_DEP_P81130-B21_P74787-B21_1790182000001] DL380_Gen12 — OPTION_TYPE_SUBSTITUTION
- **Scope**: `FAMILY_GEN`
- **Rule**: When HPE ProLiant Compute DL380 Gen12 Cooling Upgrade Enablement Kit (P81130-B21) is selected, the only supported heatsink is HPE ProLiant Compute DL3XX Gen12 High Performance Heat Sink Kit (P74787-B21).
- **Affected SKU**: `P81130-B21`
- **Required Dependency**: `P74787-B21`

### 67. [DELTA_RAG_DEP_P81130-B21_P79555-B21_1790182000002] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
- **Rule**: HPE ProLiant Compute DL380 Gen12 Cooling Upgrade Enablement Kit (P81130-B21) supports processors up to 270W at 30C or up to 350W at 27C (P79555-B21).
- **Affected SKU**: `P81130-B21`
- **Required Dependency**: `P79555-B21`

### 68. [DELTA_RAG_DEP_P10115-B21_P72203-B21_1790182000003] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
- **Rule**: Rear OCP Slot B on DL380 Gen12 NC chassis is unpowered and logically disconnected by default; configuring an OCP NIC requires P72203-B21 cable kit to route PCIe lanes from CPU 1.
- **Affected SKU**: `P10115-B21`
- **Required Dependency**: `P72203-B21`

### 69. [DELTA_RAG_DEP_P78279-B21_P74755-B21_1790182000004] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `FAMILY_GEN`
- **Rule**: HPE NS204i-u v2 480GB NVMe Hot Plug Boot Storage Device (P78279-B21) requires HPE ProLiant Compute DL380 Gen12 NS204i-u Rear Boot Device Enablement Kit (P74755-B21).
- **Affected SKU**: `P78279-B21`
- **Required Dependency**: `P74755-B21`

### 70. [DELTA_CLIC_RULE_81392332_H200_16PIN_P93055-B21] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Rule 81392332: P56072-B21 requires to be ordered with supported 8-pin GPUs. H200 NVL mandates P93055-B21 HPE GPU 16-pin Power Cable Kit.
- **Affected SKU**: `S3U30C`
- **Required Dependency**: `P93055-B21`

### 71. [DELTA_CLIC_RULE_81394885_SECONDARY_RISER_25C_AMBIENT] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Rule 81394885: 1 qty 8SFF Cage + Processor above 270W + Air Cooled: H200 NVL (S3U30C) is not supported on Primary Riser (20C-30C) or Tertiary Riser (20C-30C). Supported on Secondary Riser only with <= 25C ambient temperature.
- **Affected SKU**: `S3U30C`
- **Required Dependency**: `P51083-B21`

### 72. [DELTA_CLIC_RULE_81393803_STORAGE_CABLE_P76453-B21] DL380_Gen12 — DEPENDENCY_CHAIN
- **Scope**: `CHASSIS_SPECIFIC`
- **Rule**: Rule 81393803: P73282-B21 with 8SFF x1 Cage (P75740-B21) and 1 qty MR416i-p (P47777-B21) requires 1 qty of P76453-B21 (2SFF B1/ 8SFF x1 PCIe Cable).
- **Affected SKU**: `P75740-B21`
- **Required Dependency**: `P76453-B21`

### 73. [OWNER_STANDARD_3Y_BASIC] GLOBAL — SUPPORT_POLICY
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: Preserve explicit customer support term and tier in the closest rank; use 3-year Tech Care Basic only when unspecified or explicitly authorized. For this SN3600B BOQ the owner authorized 5-year Essential to 3-year Basic. Compare qualified fixed and flexible service options; disclose retention and preserve parent/suffix pairs. This commercial preference is not vendor qualification.

### 74. [OWNER_ICON_SERVICE_ISOLATION] GLOBAL — ICON_SUPPORT_ISOLATION
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: Select Services from Components for the owning icon, edit its dropdowns, and leave both apply-to-all icons and apply-to-all nodes off. Different icons retain their own SLA.

### 75. [OWNER_OCA_EXPIRED_SESSION] GLOBAL — SESSION_RECOVERY_PROTOCOL
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: When OCA says it encountered a problem, restart from Partner Portal refresh/login and open One Config Advanced through Quick Links. Do not reload the failed OCA session. Keep a Partner Portal tab before closing stale OCA so CDP does not disappear. This supersedes cache-flush advice for encountered-a-problem errors.

### 76. [OWNER_CLOSEST_REQUIREMENT_RANK] GLOBAL — CUSTOMER_INTENT_POLICY
- **Scope**: `UNIVERSAL_VENDOR`
- **Rule**: Closest rank preserves customer requirements and makes only necessary compatibility/buildability changes. Budget alternatives disclose every deviation; do not silently reduce term, tier, capacity or resilience. Keep explicit owner overrides auditable against the original customer BOQ.

### 77. [OWNER_COMPONENT_DOMAIN_ROUTING] GLOBAL — COMPONENT_DOMAIN_ROUTING
- **Scope**: `UNIVERSAL_VENDOR`
