...
**Target Product**: `hpe-chaos-test-oJrVbu`  
**Sync Timestamp**: 2026-08-20T13:21:48.619Z  
**Total Verified SKUs**: `3` (`3` Hardware + `0` Services)  
**Total Synced KnowledgeDeltas**: `96`  
...
## 🎯 3. Chassis & Solution-Type Gotchas (hpe-chaos-test-oJrVbu)
...
*No discontinued or reinstated SKUs detected for hpe-chaos-test-oJrVbu. All cataloged SKUs are active.*
...
|--------------------|----------------|------------|-------------|--------------|
| **DL380_Gen12_SFF** | ProLiant | Gen12 | SFF | `P73282-B21` |
| **DL380_Gen11** | ProLiant | Gen11 | SFF | `P52534-B21` |
...
| **chassis_base_skus_by_family_gen** | ProLiant | Gen12 | SFF | `N/A` |
| **chassis_base_skus** | ProLiant | Gen12 | SFF | `N/A` |
