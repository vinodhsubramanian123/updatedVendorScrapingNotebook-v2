...
const { sendCommand, getOCATarget, connectWS, sleep } = require('../lib/scraper/cdp.js');
...
async function main() {
  ...
  try {
    ...
    try { ws.close(); } catch (e) { console.warn('Caught suppressed error in live_visual_demo_cdp.js:', e); }
  }
}
