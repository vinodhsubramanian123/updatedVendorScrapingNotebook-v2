...
const CERT_STEPS = [
  { id: 'bootstrap', label: 'Bootstrap artifact check', cmd: 'node scripts/bootstrap_gen12.js', skipInReport: true },
  { id: 'pipeline_evals', label: 'Post-flight pipeline guardrails', cmd: `node scripts/test_pipeline_evals.js --post-flight-only "${XLSX_PATH}"` },
  { id: 'conflict_graph', label: 'Conflict graph unit tests', cmd: 'node tests/test_conflict_graph.js' },
  { id: 'e2e_scenarios', label: 'End-to-end scenario tests', cmd: 'node tests/test_end_to_end_scenarios.js' },
  { id: 'offline_pipeline', label: 'Offline pipeline fallback tests', cmd: 'node tests/test_offline_pipeline.js' },
  { id: 'edge_cases', label: 'Edge case coverage', cmd: 'node tests/test_edge_cases.js' },
  { id: 'vendor_bom', label: 'Vendor BOM verifier tests', cmd: 'node tests/test_vendor_bom_verifier.js' },
];
