...
// Full BOM items definition for Path B (100% Official HPE Global List Prices / GPL from CLIC Export)
const PATH_B_ITEMS = [
  ...
  { sku: 'P67088-B21', desc: 'Intel Xeon-Platinum 8580 2.0GHz 60-core 350W Processor for HPE', cat: 'Processors (Cluster A)', qA: 2, qB: 0, tot: 40, price: 23877.00, rfpQty: 40, rfpSku: 'P67088-B21', role: 'Compute (60C / 350W)', status: '100% Exact Match' },
  ...
  { sku: 'P64707-F21', desc: 'HPE 64GB (1x64GB) Dual Rank x4 DDR5-5600 Registered Smart Memory Kit', cat: 'Memory (RAM)', qA: 8, qB: 8, tot: 480, price: 28532.00, rfpQty: 480, rfpSku: 'P64707-B21', role: '512GB/Node (8x 64GB Balanced)', status: '1-to-1 FIO Swap (Rules 81354490 & 91001655)' },
  { sku: 'P48814-B21', desc: 'HPE ProLiant DL380 Gen11 8SFF U.3 Premium Drive Cage Kit', cat: 'Storage Drive Cage', qA: 1, qB: 1, tot: 60, price: 416.00, rfpQty: 60, rfpSku: 'P48813-B21', role: 'Front Drive Storage (8SFF U.3 Premium)', status: 'Premium Cage (Required for P48832-B21 Cable, Rule 81354632)' },
  { sku: 'P47777-B21', desc: 'HPE MR416i-p Gen11 x16 Lanes 8GB Cache PCI SPDM Storage Controller', cat: 'Storage Controller', qA: 1, qB: 1, tot: 60, price: 5999.00, rfpQty: 60, rfpSku: 'P58335-B21', role: 'PCIe RAID Controller (8GB Cache)', status: 'Form-Factor Pivot to -p (Frees OCP Slot 1)' },
  ...
  { sku: 'P48918-B21', desc: 'HPE ProLiant Storage Controller Enablement Cable Kit', cat: 'Storage Cache Enablement Cable', qA: 1, qB: 1, tot: 60, price: 38.00, rfpQty: 0, rfpSku: 'P48918-B21', role: 'Capacitor P02377 Power Link', status: 'Mandatory Enablement Cable (CLIC Rule 81354652)' },
  ...
  { sku: 'P10115-B21', desc: 'Broadcom BCM57414 Ethernet 10/25Gb 2-port SFP28 OCP3 Adapter for HPE', cat: 'Network Adapter (OCP1)', qA: 1, qB: 1, tot: 60, price: 1231.00, rfpQty: 60, rfpSku: 'P10115-B21', role: 'High-Speed Networking (OCP Slot 1)', status: '100% Exact Match (Installed in Freed OCP Slot 1)' },
  { sku: 'P26262-B21', desc: 'Broadcom BCM57414 Ethernet 10/25Gb 2-port SFP28 Adapter for HPE', cat: 'Network Adapter (PCIe)', qA: 1, qB: 2, tot: 100, price: 1184.00, rfpQty: 160, rfpSku: 'P26262-B21', role: 'PCIe Networking (100 PCIe + 60 OCP = 160)', status: 'Fulfills 160 Total 10/25G Adapters Across System' },
  ...
  { sku: 'R2E09A', desc: 'HPE SN1610Q 32Gb 2-port Fibre Channel Host Bus Adapter', cat: 'Storage SAN Networking', qA: 2, qB: 2, tot: 120, price: 7410.00, rfpQty: 120, rfpSku: 'R2E09A', role: 'SAN Connectivity (32Gb FC)', status: '100% Exact Match' },
  ...
  { sku: 'P56073-B21', desc: 'HPE ProLiant DL380 Gen11 x16/x16/x16 Primary Cable Kit', cat: 'PCIe Riser Enablement', qA: 0, qB: 1, tot: 40, price: 409.00, rfpQty: 0, rfpSku: 'P56073-B21', role: 'Activates Slot 1 for Cluster B (5 Cards)', status: 'Mandatory Injection (Rules 81016755 & 81354683)' },
  ...
  { sku: 'P38997-B21', desc: 'HPE 1600W Flex Slot Platinum Hot Plug Low Halogen Power Supply Kit', cat: 'Power Infrastructure (Cluster B)', qA: 0, qB: 2, tot: 80, price: 890.00, rfpQty: 80, rfpSku: 'P38997-B21', role: '1+1 Redundant Platinum (Cluster B)', status: '100% Exact Match' },
  { sku: 'P35876-B21', desc: 'HPE CE Mark Removal FIO Enablement Kit', cat: 'Factory Regulatory Settings', qA: 0, qB: 1, tot: 40, price: 1.00, rfpQty: 0, rfpSku: 'P35876-B21', role: 'EU Lot 9 Regulatory Clearance', status: 'Mandatory for Platinum PSUs (EU Lot 9)' },
  ...
  { sku: 'R7A11AAE', desc: 'HPE Compute Ops Management Enhanced 3-Year SaaS Base License', cat: 'Cloud Management & Control', qA: 1, qB: 1, tot: 60, price: 450.00, rfpQty: 0, rfpSku: 'R7A11AAE', role: 'Mandatory Factory Order Control', status: 'Mandatory Injection (CLIC Rule 81322276)' }
];
