...
function buildWorkbook(outputPath = '/home/vinodh/Downloads/Untitled spreadsheet.xlsx') {
  ...
  const config1Items = [
    ...
    { sku: 'P64707-B21 0D1', category: 'Memory', desc: 'HPE 64GB (1x64GB) Dual Rank x4 DDR5-5600 CAS-46-45-45 EC8 Registered Smart FIO Memory Kit', qtyNode: 8, totalQty: 160 },
    ...
    { sku: 'P10115-B21', category: 'Network Controller', desc: 'Broadcom BCM57414 Ethernet 10/25Gb 2-port SFP28 OCP3 Adapter for HPE', qtyNode: 1, totalQty: 20 },
    ...
    { sku: 'P56073-B21', category: 'PCI-Express Slot', desc: 'HPE ProLiant DL380 Gen11 x16/x16/x16 Primary Cable Kit (Slot 1 Enablement)', qtyNode: 1, totalQty: 20 },
    ...
    { sku: 'P56074-B21', category: 'PCI-Express Slot', desc: 'HPE ProLiant DL380 Gen11 x16/x16/x16 Secondary Cable Kit (Slot 4 Enablement)', qtyNode: 1, totalQty: 20 },
  ...
  const config2Items = [
    ...
    { sku: 'P64707-B21 0D1', category: 'Memory', desc: 'HPE 64GB (1x64GB) Dual Rank x4 DDR5-5600 CAS-46-45-45 EC8 Registered Smart FIO Memory Kit', qtyNode: 8, totalQty: 320 },
    ...
    { sku: 'P10115-B21', category: 'Network Controller', desc: 'Broadcom BCM57414 Ethernet 10/25Gb 2-port SFP28 OCP3 Adapter for HPE', qtyNode: 1, totalQty: 40 },
    ...
    { sku: 'P56074-B21', category: 'PCI-Express Slot', desc: 'HPE ProLiant DL380 Gen11 x16/x16/x16 Secondary Cable Kit (Slot 4 Enablement)', qtyNode: 1, totalQty: 40 },
  ...
  const auditSummaryRows = [
    ...
    ['81354490 & 91001655', 'Memory Option Type', 'P64707-B21 is restricted from standalone quote in CTO base models', 'Standalone BTO memory SKU cannot be configured outside CTO chassis container', 'Attached P64707-B21 0D1 (Factory Integrated Option) directly into chassis container', '✅ 100% BUILDABLE'],
    ...
    ['81354654', 'Thermal Cooling Fan Kit', 'High-Performance Fan Kit (P48820-B21) maximum quantity exceeded', 'P48820-B21 is a complete 6-fan kit. Max 1 kit allowed per 2U base chassis', 'Normalized quantity to 1 kit per node (20 kits for Config 1, 40 kits for Config 2)', '✅ 100% BUILDABLE'],
    ...
    ['81016755 & 81354683', 'PCIe Riser Active Cabling', 'PCIe Cards exceed electrically active riser slot capacity', 'Primary Riser Slot 1 and Secondary Riser Slot 4 require dedicated Riser Cable Kits', 'Added P56073-B21 (Primary Cable Kit) and P56074-B21 (Secondary Cable Kit)', '✅ 100% BUILDABLE'],
    ...
    ['Chassis Map Conflict', 'Catalog Mapping', 'P48820-B21 mapped incorrectly to Cray GX5000 in chassis_map.json', 'Shared SKU collision caused DL380 Gen11 to misidentify as Cray chassis', 'Removed P48820-B21 from Cray mapping; DL380 Gen11 resolves cleanly to P52534-B21', '✅ 100% BUILDABLE']
  ];
