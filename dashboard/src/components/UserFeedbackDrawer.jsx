...
import { MessageSquare, X, Send, CheckCircle2, RefreshCw } from 'lucide-react';
...
export default function UserFeedbackDrawer({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Drawer */}
      <div className="w-full max-w-md bg-white shadow-2xl border-l border-slate-200 p-6 overflow-y-auto transition-all">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mb-6">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs font-semibold text-slate-800 [color-scheme:light]"
          >
